...
if [[ $STEP == "fTest" ]] || [[ $STEP == "calcPhotonSyst" ]] ||  [[ $STEP == "getEffAcc" ]] || [[ $STEP == 'signalFit' ]]; then
	...
	if [[ $year == $YEAR ]] || [[ $YEAR == "all" ]]; then
		...
		python RunSignalScripts.py --inputConfig config_test_${year}.py --mode signalFit --modeOpts="--doPlots --doYield --outdir plots --doEffAccFromJson" ${DROPT}
	    fi
	fi
    done
    ...
    smprocs=("GG2H" "VBF" "TTH" "WMINUSH2HQQ" "WPLUSH2HQQ" "QQ2HLL" "wh_ALT_0Mf05" "wh_ALT_0M" "VBF_ALT_0M" "VBF_ALT_0Mf05" "ZH_ALT0Mf05ph0" "ZH_ALT0M" )
